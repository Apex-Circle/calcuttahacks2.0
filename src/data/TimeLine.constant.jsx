...
export const day1Events = [
  {
    ...
    icon: <FaUserCheck className="text-red-200  text-2xl" />,
  },
  {
    time: "8:30 AM",
    ...
    icon: <FaUsers className="text-red-200  text-2xl" />,
  },
  {
    time: "9:30 AM",
    ...
    icon: <FaCode className="text-red-200  text-2xl" />,
  },
  {
    time: "10:00 AM",
    ...
    icon: <FaFlag className="text-red-200  text-2xl" />,
  },
  {
    time: "1:30 PM",
    title: "Lunch",
    ...
    icon: <FaUtensils className="text-red-200  text-2xl" />,
  },
  {
    time: "3:00 PM",
    ...
    icon: <FaGamepad className="text-red-200  text-2xl" />,
  },
  {
    time: "4:00 PM",
    title: "Mentoring",
    ...
    icon: <FaPeopleArrows className="text-red-200  text-2xl" />,
  },
  {
    time: "5:30 PM",
    title: "Tea Break",
    ...
    icon: <FaMugHot className="text-red-200  text-2xl" />,
  },
  {
    time: "9:00 PM",
    title: "Dinner",
  ...
  },
  {
    ...
    icon: <FaClipboardCheck className="text-red-200  text-2xl" />,
  },
];
...
export const day2Events = [
  {
    ...
    icon: <FaGuitar className="text-red-200  text-2xl" />,
  },
  {
    time: "2:00 AM",
    title: "Mini Games",
  ...
  },
  {
    ...
    icon: <FaMedal className="text-red-200  text-2xl" />,
  },
];
