...
const Hero = () => {
  return (
    <div className="w-full h-screen relative overflow-hidden">
      {/* Aurora background fills entire hero */}
      ...
      <div className="absolute bottom-0 w-full flex justify-center z-30">
        <div className="flex items-center justify-between p-2 w-fit h-[9vh] bg-black/80 backdrop-blur-md border-t-b border-red-900/40 rounded-t-xl shadow-[0_0_20px_rgba(255,0,60,0.2)]">
          <HeroGlassBarCard
            ...
            icon={<FaCalendar className="text-4xl text-red-900" />}
          />
          <HeroGlassBarCard
            title={"Venue"}
            highlight={"Kolkata, India"}
            icon={<FaLocationDot className="text-4xl text-red-900" />}
          />
          <HeroGlassBarCard
            title={"Format"}
            highlight={"Offline"}
            icon={<IoInformationCircle className="text-4xl text-red-900" />}
          />
          <HeroGlassBarCard
            title={"Participants"}
            highlight={"5000+"}
            icon={<IoIosPeople className="text-4xl text-red-900" />}
          />
        </div>
      </div>
    </div>
